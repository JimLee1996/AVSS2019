...
Among all of them, the proposed method achieves the best performance on all of these three datasets.
...
It implies that our model is more capable of modeling motion patterns and can effectively learn abstract features, which helps to achieve better generalization ability.
...
\begin{table}
\begin{center}
\caption{Comparision of efficiency.}
...
\end{center}
\footnotesize
The last three columns list the $n$-channel (i.e. input with $n$ batches) inference time per frame on single GTX 1080Ti.
\end{table}
